...
public class UnifiedOddsStatistics implements UnifiedOddsStatisticsMBean {
    ...
    private final ThreadLocal<byte[]> tmpBuf = ThreadLocal.withInitial(() -> new byte[200]);
...
//            fixtureChanges++;
    ...
    @Override
    public long getXmlDeserializationTimeInMs() {
        return totalXmlDeserializationTime / 1000 / 1000;
    }
