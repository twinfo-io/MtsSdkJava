...
public class TicketBuilderTest extends TimeLimitedTestBase {
    ...
    public void buildBetWithSameSelectionDifferentOddsTest()
    {
        ...
        Ticket ticket = ticketBuilderHelper.builderFactory.createTicketBuilder()
                ...
                .addBet(ticketBuilderHelper.builderFactory.createBetBuilder().addSelectedSystem(1).setBetId("bet-id-" + StaticRandom.I1000).setBetBonus(StaticRandom.I1000, BetBonusMode.ALL, BetBonusType.TOTAL, BetBonusDescription.ACCUMULATOR_BONUS, BetBonusPaidAs.CASH).setStake(92343, StakeType.TOTAL)
